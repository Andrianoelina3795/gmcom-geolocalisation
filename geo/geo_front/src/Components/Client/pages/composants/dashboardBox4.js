    ...
    return (
        <Button className="dashboardBox " style={
            ...
            <div className='d-flex w-100'>
                <div className='col1'>
                    <h4 className='text-white'>Total Activité du jour</h4>
                    <span className='text-white'>{activityToday}</span>
                </div>
